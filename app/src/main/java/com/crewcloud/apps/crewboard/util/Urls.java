...
public class Urls {
    ...
    public static final String URL_GET_USER = "/UI/MobileBoard/Handlers/MobileService.asmx/GetProfileUser";
    ...
    public static final String URL_CHANGE_PASS = "http://core.crewcloud.net/UI/WebService/WebServiceCenter.asmx/UpdatePassword";

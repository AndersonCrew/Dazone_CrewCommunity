...
/**
 * Created by dazone on 3/15/2017.
 */

public class ChildBoardsGroupAdapter  extends BaseAdapter<ChildBoards, ChildBoardsGroupAdapter.ViewHolder> {

    public ChildBoardsGroupAdapter(BaseActivity mActivity) {
        super(mActivity);
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ChildBoardsGroupAdapter.ViewHolder(view);
    }
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    EventChildBoard eventChildBoard = new EventChildBoard(getItem(getAdapterPosition()));
